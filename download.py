...
from services import download_service, get_friendly_error
...
def get_info():
    try:
        ...
        if 'user_id' in session:
            # UserRepository сам открывает соединение, лишний with get_db() не нужен
        ...
        sizes = download_service.calculate_sizes(info, is_premium)
...
def start_download():
    ...
    download_service.background_download(task_id, video_url, quality, user_id, ratelimit, limit_height, sleep_interval)
